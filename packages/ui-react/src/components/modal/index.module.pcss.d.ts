...
export const modal__body: string
export const modal__body_bottom: string
export const modal__body_default: string
export const modal__body_reduced: string
...
export const modal_center: string


interface Stylesheet {
    'modal': string
    'modal__body': string
    'modal__body_bottom': string
    'modal__body_default': string
    'modal__body_no-header': string
    'modal__body_reduced': string
    'modal__body_with-buttons': string
    ...
    'modal__icon-close': string
    'modal__icon-close_alone': string
    'modal__icon-close_default': string
    'modal_bottom': string
    'modal_center': string
}
