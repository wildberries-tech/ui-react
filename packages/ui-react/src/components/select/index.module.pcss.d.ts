...
export const select__option_focused: string
export const select__option_selected: string
export const select__placeholder: string
...
interface Stylesheet {
    ...
    'select__option_selected': string
    'select__placeholder': string
    'select__single-value': string
    'select__single-value_disabled': string
    'select__single-value_focused': string
    'select__single-value_selected': string
    'select__value-container': string
}
